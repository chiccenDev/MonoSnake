...
namespace MonoSnake
{
    ...
    public static class RectangleExtensions
    {
        ...
        /// Positive values indicate that <see cref="rectA"/> is to the right or below <see cref="rectB"/>.
        /// negative values indicate that <see cref="rectA"/> is to the left or above.
        /// If the rectangles are not intersecting, return <see cref="Vector2.Zero"/>.
        /// </returns>
        ...
        /// <summary>
        /// Gets the position of the center fo the bottom edge of the rectangle.
        /// </summary>
        /// <param name="rect">The rectangle to calculate from.</param>
        /// <returns>A <see cref="Vector2"/> representing the bottom-center point of the rectangle.</returns>
