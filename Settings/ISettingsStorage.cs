...
namespace MonoSnake.Settings
{
    ...
    public interface ISettingsStorage
    {
        ...
        /// <exception cref="IOException">Thrown if saving failes due to file system issues.</exception>
        /// <exception cref="UnathorizedAccessException">Thrown if permission to write the file is denied.</exception>
        void SaveSettings<T>(T settings) where T : new();

        /// <summary>
        /// Load settings from storage. If no settings exist, it should return <c>null</c> or a default instance.
        /// </summary>
        /// <typeparam name="T">The type representing the settings data.</typeparam>
