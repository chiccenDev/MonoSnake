...
{
    /// <summary>
    /// Provides a base implementation for storing and retreiving application settings in JSON format.
    /// </summary>
    public abstract class BaseSettingsStorage : ISettingsStorage
    {
        ...
        /// </summary>
        protected Environment.SpecialFolder SpecialFolderPath { get; set; }
        ...
        /// <summary>
        /// Gets the full path wheret he settings file will be stored.
        /// </summary>
